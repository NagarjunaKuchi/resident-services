...
import io.mosip.tf.packet.constant.MappingJsonConstants;
import io.mosip.tf.packet.constant.RegistrationConstants;
import io.mosip.tf.packet.constant.ResidentErrorCode;
import io.mosip.tf.packet.dto.IdRequestDto;
import io.mosip.tf.packet.dto.IdResponseDTO;
import io.mosip.tf.packet.dto.IdResponseDTO1;
import io.mosip.tf.packet.dto.RequestDto1;
import io.mosip.tf.packet.dto.VidResponseDTO1;
...
public class Utilities {
	...
	@Value("${provider.packetwriter.mosip}")
